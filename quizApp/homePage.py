...
from participant import participantLogin
...
def Home(root, frame1, frame2):
    ...
    # Participant Login
    participant = Button(frame1, text="Participant Login", width=15, command=lambda: participantLogin(root, frame1))

    # Creates new tab, if necessary
    ...
    participant.grid(row=5, column=1, columnspan=2)
